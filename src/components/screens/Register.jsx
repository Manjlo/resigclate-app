      ...
      <div className="flex flex-col w-full items-center pt-4 mt-4 mb-4">
        ...
        <ul>
          <li>
            ...
            <InfoItem styleMissing={'sm:mr-6'} type={'email'} text={'Tu correo usuario'}/>
            <InfoItem styleMissing={'sm:mr-6'} type={'password'} text={'Tu contraseña'}/>
            <InfoItem styleMissing={'sm:mr-6'} type={'tel'} text={'+57 Tu celular'}/>
          </li>
        </ul>
